...
var ValidaCPF = /*#__PURE__*/function () {
  ...
  _createClass(ValidaCPF, [{
    ...
    value: function geraNovoCpf() {
      ...
      var digito1 = this.geraDigito(cpfSemDigito);
    ...
    value: function geraDigito(cpfSemDigito) {
      var total = 0;
      var regressivo = cpfSemDigito.length + 1;
...
var AprendendoStatic = /*#__PURE__*/function () {
  function AprendendoStatic() {
    _classCallCheck(this, AprendendoStatic);
  }
  _createClass(AprendendoStatic, null, [{
    key: "meuNome",
    value: function meuNome() {
      return "Gabriel";
    }
  }]);
  return AprendendoStatic;
}();
